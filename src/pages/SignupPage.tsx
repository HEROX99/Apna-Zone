...
const SignupPage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = 'Apna Zone - Sign Up';
  }, []);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // For demo, automatically redirect to login page
      navigate('/login');
    }, 1500);
  };
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6">
          <div className="text-center mb-8">
            <UserPlus size={36} className="mx-auto text-[#3046C6]" />
            <h1 className="mt-4 text-2xl font-bold text-gray-800">Create an Account</h1>
            <p className="mt-2 text-gray-600">Join Apna Zone for B.Tech students</p>
          </div>
